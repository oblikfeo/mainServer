...
return [
    ...
    /**
     * WiFi3 (94.156.114.0, Франкфурт, PLAY2GO AS215439): общая VLESS Reality,
     * одна ссылка на всех. Донор github.com, порт 443, без flow.
     * Развёрнут 03.09.2026 взамен 185.223.253.246 (TerraTransit), ушедшего в блок.
     * Папка с доступами: nadezhdaVPN/servers/play2go-de/.
