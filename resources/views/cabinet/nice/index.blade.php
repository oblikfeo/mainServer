...
@section('meta_description', 'Выполняйте задания — получайте награды: дни, эксклюзивные возможности и бесплатные месяцы.')
    ...
    <div class="lp-container">
        ...
        <section class="lp-nice-hero">
            ...
            <p class="lp-nice-hero__lead">
                Шесть простых шагов — и к подписке добавляются дни, новые устройства и бесплатные месяцы. Прогресс считается автоматически.
            </p>
