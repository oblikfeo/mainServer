<x-cabinet-layout>
    <div class="max-w-4xl mx-auto space-y-8">
        @if ($items === [])
            <div class="rounded-2xl border-2 border-dashed border-slate-200 bg-white p-8 sm:p-10 text-center shadow-sm ring-1 ring-slate-900/5">
                <p class="text-slate-700 font-medium">У вас пока нет привязанных подписок.</p>
                <p class="mt-2 text-sm text-slate-500">Если подписка уже есть — администратор привяжет её к аккаунту. Войдите с тем же email, что указали при оформлении.</p>
