    ...
    <div class="lp-ref-milestones">
        <article class="lp-ref-milestone">
            <div class="lp-ref-milestone__head">
                <span class="lp-ref-milestone__title">Оплаты до нового устройства</span>
                <span class="lp-ref-milestone__ratio tabular-nums">2/4</span>
            </div>
            <div class="lp-ref-bar" role="img" aria-label="Выполнено 2 из 4 оплат">
                <span class="lp-ref-bar__fill" style="width:50%;"></span>
            </div>
            <p class="lp-ref-milestone__hint">Ещё 2 оплаты по вашим приглашениям — и бонус станет доступен.</p>
        </article>

        <article class="lp-ref-milestone">
            <div class="lp-ref-milestone__head">
                <span class="lp-ref-milestone__title">Приглашённых друзей</span>
