    ...
    <div class="lp-ref-milestones">
        <article class="lp-ref-milestone">
            <div class="lp-ref-milestone__head">
                <span class="lp-ref-milestone__title">До +1 устройства</span>
                <span class="lp-ref-milestone__ratio tabular-nums">2/4</span>
            </div>
            <div class="lp-ref-bar" role="img" aria-label="2 из 4 оплат">
        ...
        <article class="lp-ref-milestone">
            <div class="lp-ref-milestone__head">
                <span class="lp-ref-milestone__title">До безлимита</span>
                <span class="lp-ref-milestone__ratio tabular-nums">6/10</span>
            </div>
            <div class="lp-ref-bar" role="img" aria-label="6 из 10 оплат">
