...
<div class="lp-f1 lp-f1-body">
    <div class="lp-container">
        ...
        <div class="lp-manifesto">
            ...
            <p>Мы создали этот сервис для наших близких и друзей, когда заметили, что интернет стал нестабильным: сообщения не доходят, страницы долго загружаются, связь прерывается.</p>
