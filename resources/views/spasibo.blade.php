...
<div class="lp-f1 lp-f1-body">
    <div class="lp-container lp-container--agreement">
        ...
        <div class="lp-agreement-hero">
            <h1>Спасибо!</h1>
            <p class="lp-agreement-sub">Платёж принят. Подписка появится в кабинете автоматически после подтверждения банком (обычно до минуты). Если не появилась — обновите страницу «Мои подписки» в кабинете.</p>
        ...
        @if (! empty($referralLink))
            @include('partials.referral-share-agreement', ['referralLink' => $referralLink])
        @endif
