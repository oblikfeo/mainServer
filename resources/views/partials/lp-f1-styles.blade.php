<style>
    ...
    .lp-f1 .lp-ref-quest__prize-kicker {
        display: block;
    ...
    /* Рефералка v2: шкала-путь */
    .lp-f1 .lp-ref2-banner {
        margin: -0.5rem 0 0 0;
        padding: 0.35rem 0.5rem;
        border: 2px dashed #94a3b8;
        background: #f8fafc;
    }
    .lp-f1 .lp-ref2-hero__lead {
        margin: 0.5rem 0 0 0;
        font-size: 0.8125rem;
        font-weight: 600;
        color: #555;
    ...
    .lp-f1 .lp-ref2-scale__meta-label {
        font-size: 0.5625rem;
        font-weight: 800;
        text-transform: uppercase;
        letter-spacing: 0.08em;
    ...
    .lp-f1 .lp-ref2-scale__meta-value {
        font-size: 1.25rem;
        font-weight: 900;
        color: var(--lp-orange);
    }
    .lp-f1 .lp-ref2-scale__viewport {
        position: relative;
        margin-top: 0.25rem;
        padding: 0 0.15rem 0;
        min-height: 8.5rem;
    ...
    .lp-f1 .lp-ref2-scale__fill {
        ...
        background: var(--lp-orange);
        z-index: 1;
        border-right: 3px solid var(--lp-ink);
        box-sizing: border-box;
        transition: width 0.45s ease;
        pointer-events: none;
    }
    .lp-f1 .lp-ref2-scale__stops {
        list-style: none;
        margin: 0;
        padding: 0 0 2px 0;
        position: relative;
    ...
    .lp-f1 .lp-ref2-scale__stop-title {
        font-size: 0.5625rem;
        font-weight: 900;
        text-transform: uppercase;
        letter-spacing: 0.04em;
    ...
    .lp-f1 .lp-ref2-scale__stop-prize {
        font-size: 0.625rem;
        font-weight: 700;
        color: #475569;
        line-height: 1.25;
    }
    .lp-f1 .lp-ref2-scale__stop-tag {
        font-size: 0.45rem;
        font-weight: 900;
        text-transform: uppercase;
        letter-spacing: 0.06em;
    ...
    .lp-f1 .lp-ref2-scale__stop--accent .lp-ref2-scale__stop-dot {
        background: var(--lp-orange);
    }
    .lp-f1 .lp-ref-share {
        margin-top: 1.15rem;
