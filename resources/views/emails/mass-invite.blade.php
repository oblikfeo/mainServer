        ...
        <div style="background:#ffffff;border:4px solid #000000;border-radius:14px;overflow:hidden;">
            <div style="padding:18px 18px 14px 18px;border-bottom:4px solid #000000;">
                ...
                <div style="margin-top:10px;font-size:13px;line-height:1.5;color:#334155;">
                    По вашей подписке для вас заведён личный кабинет; аккаунт создан автоматически. Логин — ниже. Пароль задайте на странице восстановления доступа — в письмах пароли не направляем.
                </div>
            </div>
